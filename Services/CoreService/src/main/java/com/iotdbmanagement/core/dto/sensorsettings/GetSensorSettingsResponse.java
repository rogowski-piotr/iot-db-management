...
public class GetSensorSettingsResponse {
    ...
    public static Function<Collection<com.iotdbmanagement.core.sensorsettings.SensorSettings>, Iterable<GetSensorSettingsResponse.SensorSettings>> entityToDtoMapper() {
